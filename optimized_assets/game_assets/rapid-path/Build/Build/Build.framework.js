...
// end include: preamble.js
  ...
  function _SetWebGLCursorHidden(hidden) {
      var cssValue = hidden ? "none" : "auto";
  
      if (typeof Module !== "undefined" && Module.canvas) {
        Module.canvas.style.cursor = cssValue;
      }
      ...
      if (typeof document !== "undefined") {
        ...
        if (document.documentElement) {
          document.documentElement.style.cursor = cssValue;
        }
      }
    }
...
var wasmImports = {
  ...
  "SetWebGLCursorHidden": _SetWebGLCursorHidden,
